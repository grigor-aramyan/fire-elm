...
var _user$project$Decoders$contactDecoder = A4(
...
var _user$project$Decoders$contactListDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'total_pages',
	_elm_lang$core$Json_Decode$int,
	A3(
		...
		A3(
			...
			A3(
				...
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Model$ContactList)))));
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"message":"Messages.Msg","aliases":{"Http.Response":{"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }","args":["body"]},"Model.ContactList":{"type":"{ entries : List Model.Contact , page_number : Int , total_entries : Int , total_pages : Int }","args":[]},"Model.Contact":{"type":"{ id : Int , first_name : String , last_name : String , gender : Int , birth_date : String , location : String , phone_number : String , email : String , headline : String , picture : String }","args":[]}},"unions":{"Dict.NColor":{"tags":{"Black":[],"BBlack":[],"Red":[],"NBlack":[]},"args":[]},"Result.Result":{"tags":{"Err":["error"],"Ok":["value"]},"args":["error","value"]},"Http.Error":{"tags":{"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"],"BadUrl":["String"],"NetworkError":[]},"args":[]},"Dict.LeafColor":{"tags":{"LBlack":[],"LBBlack":[]},"args":[]},"Messages.Msg":{"tags":{"HandleSearchInput":["String"],"HandleFormSubmit":[],"Paginate":["Int"],"FetchResult":["Result.Result Http.Error Model.ContactList"]},"args":[]},"Dict.Dict":{"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]},"args":["k","v"]}}},"versions":{"elm":"0.18.0"}});
}
